  ...
  const handleViewItinerary = async (destination: Destination) => {
    try {
      ...
      if (data.success && data.itinerary) {
        ...
        // Transform days array from the dailyItinerary array
        const days = rawItinerary.dailyItinerary.map((day: any) => ({
          day: day.day,
          activities: day.activities,
          meals: Object.values(day.meals).filter((meal: any) => meal && meal !== 'none'),
          transportationType: day.transportationType,
          accommodation: day.accommodation !== 'none' ? day.accommodation : '',
          estimatedCosts: {
        ...
        console.log('Transformed itinerary:', transformedItinerary); // Add this for debugging
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            {recommendations && (
              <div className="space-y-6">
                {JSON.parse(recommendations).destinations.map((dest: any, index: number) => (
      ...
      case 5:
        return selectedDestination ? (
          <div className="space-y-8">
            ...
            {/* Map View */}
            {selectedDestination.itinerary?.locations && (
